<?php
  ...
  $sql="SELECT IDEstacion, Clave, Ubicacion, Estado from Estacion";
  ...
  <body id="divgris">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <ul class="navbar-nav bd-navbar-nav flex-row">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="">Estaciones</a>
        </li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10" id="divblanco">
          <center><h1>Estaciones del Sistema</h1></center>

		      <div class="container" id="divblanco">
		        <div id="divblanco" class=""> 
		          ...
		          ?>
		          <div id="divdark" class="responsive">
		            <center><h4>Estación #<?php echo $mostrar[0];  ?></h4></center>
				            ...
				            <?php }  
				            		...
				            		<center><img src="300x300.png" class="img-responsive"></center>
				            <?php		
				            		}
				            ?>

		            <center><h4>Ubicación</h4></center>
		            <center><p><?php echo $mostrar[2]; ?></p></center>
